...
public class TVSeriesReader
{
    ...
    public ArrayList<TVSerie> read() throws IOException
    {
        BufferedReader br = new BufferedReader(new FileReader(fileName));
        ArrayList<TVSerie> series = read(br);
        br.close();
        return series;
    }
    
    public ArrayList<TVSerie> read(BufferedReader br)
    {
        try{
    ...
    public ArrayList<Image> getTVPictures(){
        ArrayList<Image> tvPictureFiles = new ArrayList<Image>();
        for(TVSerie t : series){
            tvPictureFiles.add(t.getPicture());
        }
        return tvPictureFiles;
    }
}